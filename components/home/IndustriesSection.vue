    ...
    <div class="frame border-b border-line">
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-4">
        <div
          ...
          :key="industry.slug"
          class="group flex items-center gap-4 border-b border-line px-6 py-8 transition-colors hover:bg-paper-soft sm:border-l lg:border-b-0"
          :title="industry.description"
        >
          <span class="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-accent/10 text-accent transition-colors group-hover:bg-accent group-hover:text-white">
