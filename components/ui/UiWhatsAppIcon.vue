...
// The WhatsApp glyph, extracted because the same 700-character path was pasted
// three times inside WhatsAppFloat and the hero CTA now needs a fourth copy.
// Purely decorative — every call site already labels itself in text, so this is
