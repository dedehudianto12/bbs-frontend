...
const socials = [
  ...
  { label: contactInfo.telepon, href: `tel:${contactInfo.teleponTel}`, icon: 'phone' },
]
          ...
          <ul class="space-y-3.5">
            <li v-for="s in socials" :key="s.label">
              ...
              >
                ...
                <svg v-else-if="s.icon === 'pin'" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" aria-hidden="true"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg>
                <svg v-else class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M6.5 3.5h3l1.5 4-2 1.5a12 12 0 0 0 6 6l1.5-2 4 1.5v3a1.5 1.5 0 0 1-1.6 1.5A16.5 16.5 0 0 1 5 5.1 1.5 1.5 0 0 1 6.5 3.5z" /></svg>
                {{ s.label }}
              </component>
            </li>
          </ul>
