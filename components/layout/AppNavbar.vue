  ...
  <nav class="sticky top-0 z-50 border-b border-line bg-white/85 backdrop-blur-xl">
    <div class="frame flex h-16 items-center gap-6 px-5 md:px-8">
      ...
      <div class="ml-auto hidden items-center gap-3 lg:flex">
        ...
        <a :href="ctaHref" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded bg-[rgb(var(--accent))] px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-[rgb(var(--accent-glow))]">
          {{ ctaLabel }}
        </a>
      </div>
    ...
    >
      <div v-show="isOpen" class="border-t border-line bg-white px-5 pb-6 pt-2 lg:hidden">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          class="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-md bg-[rgb(var(--accent))] px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[rgb(var(--accent-glow))]"
          @click="isOpen = false"
        >
          {{ ctaLabel }}
        </a>
