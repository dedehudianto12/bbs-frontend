...
var index_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ vueExports.defineComponent({
	...
	async setup(__props) {
		...
		useHead$1({
			...
			meta: [{
				name: "description",
				content: "Timing Belt, Fastener, Cleat, Gravity Roll, dan komponen conveyor pendukung berkualitas."
			}]
		});
...
var lainnya_default = index_vue_vue_type_script_setup_true_lang_default;

export { lainnya_default as default };
//# sourceMappingURL=lainnya-DxGQC1Xv.mjs.map
