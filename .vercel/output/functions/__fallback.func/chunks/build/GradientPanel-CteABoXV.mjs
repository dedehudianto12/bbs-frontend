...
var GradientPanel_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ vueExports.defineComponent({
	...
	setup(__props) {
		...
		const motif = vueExports.computed(() => {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (!vueExports.unref(slots).default) {
			...
			if (!vueExports.unref(slots).default) _push(`<span class="absolute left-3 top-3 flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-[0.14em] text-muted/70" aria-hidden="true"><span class="h-2 w-2 border-l-2 border-t-2 border-accent"></span> REF </span>`);
			else _push(`<!---->`);
