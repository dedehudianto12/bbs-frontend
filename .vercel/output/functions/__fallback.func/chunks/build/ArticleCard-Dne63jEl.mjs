...
import { defineComponent, computed, mergeProps, withCtx, unref, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttr } from 'vue/server-renderer';

//#region components/article/ArticleCard.vue?vue&type=script&setup=true&lang.ts
var ArticleCard_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	__name: "ArticleCard",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						createVNode("p", { class: "flex items-center gap-2 text-[10.5px] font-semibold uppercase tracking-[0.14em] text-muted" }, [createVNode("span", {
							...
							"aria-hidden": "true"
						}), createTextVNode(" " + toDisplayString(__props.tag || "Artikel"), 1)]),
						...
						__props.publishedAt ? (openBlock(), createBlock("div", {
							key: 0,
							class: "mt-3 text-[10.5px] font-medium uppercase tracking-[0.1em] tabular-nums text-muted/70"
						}, [createVNode("time", { datetime: __props.publishedAt }, toDisplayString(new Date(__props.publishedAt).toLocaleDateString("id-ID", {
							year: "numeric",
							month: "short",
							day: "numeric"
						})), 9, ["datetime"])])) : createCommentVNode("", true)
					])];
				}),
				_: 1
			}, _parent));
