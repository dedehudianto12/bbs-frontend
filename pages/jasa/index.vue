...
<template>
  <div>
    ...
    <div class="container-tech py-16 md:py-24">
      <div v-if="serviceErr" class="rounded-none border border-red-200 bg-red-50 px-6 py-10 text-center">
        ...
        <button @click="() => refreshNuxtData('jasa-listing')" class="mt-4 cursor-pointer rounded-none bg-accent px-5 py-2 text-[13px] font-semibold text-white border-none">Coba Lagi</button>
      </div>
      ...
      <p v-else class="rounded-none border border-dashed border-line py-16 text-center text-sm text-muted">Belum ada layanan tersedia.</p>
    </div>
