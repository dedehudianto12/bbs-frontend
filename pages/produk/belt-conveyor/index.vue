  ...
  <div>
    ...
    <div v-if="productErr" class="container-tech py-12">
      <div class="rounded-xl border border-red-200 bg-red-50 px-6 py-8 text-center">
        ...
        <button @click="() => refreshNuxtData('produk-belt-conveyor')" class="mt-4 cursor-pointer rounded-md bg-accent px-5 py-2 text-[13px] font-semibold text-white border-none">Coba Lagi</button>
      </div>
    </div>
